...
[comment]: <> (Then you need to go in the `Build & Development Settings` and change the `OUTPUT DIRECTORY` to `dist/apps/ecommerce-storefront-b2b`)

[comment]: <> (That's it, your ecommerce store is up and running :rocket:)

You need to go in the `Build & Development Settings` and change the `OUTPUT DIRECTORY` to `dist/apps/ecommerce-storefront-b2b`
