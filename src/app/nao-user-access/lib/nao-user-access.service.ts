...
import {CurrencyData, naoAccessToken$} from '../../nao-utils';
...
export class NaoUserAccessService {
  ...
  get userData(): BehaviorSubject<NaoUsersInterface.UserData|null> {
    return NaoUserAccessData.userData;
  }


  get roleData(): BehaviorSubject<NaoUsersInterface.Role|null> {
  ...
  get oldRoleData(): BehaviorSubject<NaoUsersInterface.Role|null> {
  ...
  get status(): string | null {
    if (this.userData.getValue() !== null) {
      // @ts-ignore
      return this.userData.getValue().status;
    }
    return null;
  }
  ...
  get state(): string | null {
    if (this.userData.getValue() !== null) {
      // @ts-ignore
      return this.userData.getValue().state;
    }
    return null;
  }
   ...
   * Find currency
   */
  public findCurrency(currencyCode: string): CurrencyData | null {
