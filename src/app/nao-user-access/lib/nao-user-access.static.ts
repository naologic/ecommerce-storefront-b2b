...
import { naoAccessToken$, NaoLocalStorageClass } from '../../nao-utils';
import { NaoStreamInterface } from "../../nao-interfaces";
...
export const NaoUserAccessData = {
  ...
  userData: new BehaviorSubject<NaoUsersInterface.UserData|null>(null),
  companyId: new BehaviorSubject<string|null>(null),
  companyData: new BehaviorSubject<NaoCompanyInterface.Company|null>(null),
  rolePermissions$: new BehaviorSubject<string[]>([]),
  roleData: new BehaviorSubject<NaoUsersInterface.Role|null>(null),
  ads: new BehaviorSubject<any>(null),
  oldRoleData: new BehaviorSubject<NaoUsersInterface.Role|null>(null),
