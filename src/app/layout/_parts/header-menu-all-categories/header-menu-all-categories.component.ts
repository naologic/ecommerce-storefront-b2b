...
@Component({
  selector: "app-header-menu-all-categories",
  templateUrl: "./header-menu-all-categories.component.html",
  styleUrls: ["./header-menu-all-categories.component.scss"]
})
export class HeaderMenuAllCategoriesComponent implements OnInit, OnDestroy {
